    ...
    if context.get("kindDeploymentRequested") and kind_deployment.get("enabled"):
        supported_calls["kind_deployment"] = {
            ...
            "arguments": {
                ...
                "validator": kind_deployment.get("validator"),
                "validatorConfig": kind_deployment.get("validatorConfig") or {},
                "execute": mutating_execute,
            },
            "call": lambda: tools.kind_deployment_runner(
                ...
                validator=str(kind_deployment.get("validator") or ""),
                validator_config=kind_deployment.get("validatorConfig") or {},
                execute=mutating_execute,
