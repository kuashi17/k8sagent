"""Declarative lifecycle validator for generated Operator projects."""
...
class DeploymentValidator(Protocol):
    ...
    def planned_steps(self, include_lifecycle: bool) -> list[dict[str, Any]]: ...
...
class ManagedResourceValidator:
    """Validate managed and observed resources from a lifecycle contract."""
